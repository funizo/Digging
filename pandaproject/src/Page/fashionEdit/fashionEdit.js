...
function Edit() {
    ...
    const [writeData,setWriteData] = useState({
        title:fashionData.fashionTitle,
        content:fashionData.fashionContent,
        price:fashionData.price,
        _id:fashionData._id,
        image:null
    })
    useEffect(() => {
    ...
    const handleSubmit = async(e) => {
        ...
        if (writeData.title === '' || writeData.content === '') {
            ...
            try {
                ...
                const res = await fetch("http://localhost:8080/fashion/fashionedit", {
                    method: "POST",
                    body: formData,
                });
