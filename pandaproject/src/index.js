...
root.render(
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/category/fashion" element={<Content Category="fashion"/>} />
        <Route path="/category/electronic" element={<Content Category="electronic"/>} />
        <Route path="/category/toy" element={<Content Category="toy"/>} />
        <Route path="/category/goods" element={<Content Category="goods"/>} />

        <Route path="/register/book" element={<ContentRegister Category="book"/>} />
        <Route path="/register/fashion" element={<ContentRegister Category="fashion"/>} />
        <Route path="/register/electronic" element={<ContentRegister Category="electronic"/>} />
        <Route path="/register/toy" element={<ContentRegister Category="toy"/>} />
        <Route path="/register/goods" element={<ContentRegister Category="goods"/>} />


        <Route path="/category/book/detail/:id" element={<ContentDetail Category="book"/>} />
        <Route path="/category/fashion/detail/:id" element={<ContentDetail Category="fashion"/>} />
        <Route path="/category/electronic/detail/:id" element={<ContentDetail Category="electronic"/>} />
        <Route path="/category/toy/detail/:id" element={<ContentDetail Category="toy"/>} />
        <Route path="/category/goods/detail/:id" element={<ContentDetail Category="goods"/>} />


        <Route path="/edit/book/:id" element={<ContentEdit Category="book"/>} />
        <Route path="/edit/fashion/:id" element={<ContentEdit Category="fashion"/>} />
        <Route path="/edit/electronic/:id" element={<ContentEdit Category="electronic"/>} />
        <Route path="/edit/toy/:id" element={<ContentEdit Category="toy"/>} />
        <Route path="/edit/goods/:id" element={<ContentEdit Category="goods"/>} />
